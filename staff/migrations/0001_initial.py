    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dress_size', models.ForeignKey(to='staff.DressSize', null=True, help_text='Mitwirkende bekommen T-Shirts um sie besser zu erkennen. Damit dein T-Shirt passt brauchen wir deine Größe.', verbose_name='Kleidergröße', blank=True)),
                ...
                ('tutor_for', models.ForeignKey(to='staff.GroupCategory', null=True, help_text='Erstsemester welches Studiengangs möchtest du als Tutor betreuen?', verbose_name='Tutor für', blank=True)),
            ],
            options={
                'verbose_name': 'Person',
