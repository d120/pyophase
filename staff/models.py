...
class Person(models.Model):
    ...
    tutor_experience = models.PositiveSmallIntegerField(verbose_name=_("Anzahl Tutorentätigkeiten"), help_text=_("Wie oft warst du bereits Ophasentutor"), default=0, blank=True, null=True)
