...
{ {{ person.nametag_shortname }} } { {{ person.nametag_long }} } {% else %} {~}{~} {% endif %}{% if 'Helpdesk' in person.get_orgajob_names %} {H} {% else %}
{~} {% endif %} {% if 'Leitung' in person.get_orgajob_names %} {L} {% else %} {~} {% endif %}
{% endfor %}
\end{document}
{% endautoescape %}
